export const Sidebar = ({ children, isOpen, closeSidebar }) => {
    return (
        <>
            <aside onClick={(event) => event.stopPropagation()} className={`${isOpen ? 'translate-x-0' : 'translate-x-full'} z-50 top-0 right-0 fixed h-full w-full bg-white p-8 transition duration-300 overflow-auto md:w-1/2 lg:w-[35%]`}>
